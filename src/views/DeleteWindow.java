...
public class DeleteWindow extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == jButton1){
            ...
            int choice = JOptionPane.showConfirmDialog(this, "Desea eliminar el candidato \n " + candidato);
            if(choice == 0){
                String mensaje = controller.removeCandidato(candidato)?"Candidato eliminado":"No se pudo eliminar el candidato";
